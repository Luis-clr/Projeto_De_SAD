...
--Tabela de agregados
CREATE TABLE FATO_CONTRATO_INSTITUICAO_MENSAL (
	ID_TEMPO BIGINT NOT NULL,
	ID_INSTITUICAO INT NOT NULL,
	VALOR NUMERIC(10,2) NOT NULL,
	QUANTIDADE INT NOT NULL,
	CONSTRAINT FK_DIM_INSTITUICAO_FATO_CONTRATO_INSTITUICAO_MENSAL FOREIGN KEY (ID_INSTITUICAO) REFERENCES DIM_INSTITUICAO (ID_INSTITUICAO),
	CONSTRAINT FK_TEMPO_FATO_CONTRATO_INSTITUICAO_MENSAL FOREIGN KEY (ID_TEMPO) REFERENCES DIM_TEMPO (ID_TEMPO),
)


CREATE INDEX IX_CONTRATO_INSTITUICAO_MENSAL_TEMPO ON FATO_CONTRATO_INSTITUICAO_MENSAL (ID_TEMPO)
CREATE INDEX IX_CONTRATO_INSTITUICAO_MENSAL_INSTITUICAO ON FATO_CONTRATO_INSTITUICAO_MENSAL(ID_INSTITUICAO)
