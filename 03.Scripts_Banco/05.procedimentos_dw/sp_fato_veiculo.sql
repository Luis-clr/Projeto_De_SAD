...
BEGIN
	...
	OPEN CURSO
	FETCH NEXT FROM CURSO INTO @COD_TIPO_VEICULO,@COD_SECRETARIA,@COD_INSTITUICAO,@COD_VEICULO,@PLACA,@MARCA,@MODELO,@ANO_FABRICACAO,@ANO_MODELO,@COR,@TIPO_OBSERVACAO
	...
	BEGIN
		...
		IF EXISTS(SELECT * FROM FATO_VEICULO WHERE COD_VEICULO = @COD_VEICULO)
		BEGIN
			UPDATE FATO_VEICULO
